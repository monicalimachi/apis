...
def test_user(client):
    user_data = {"email":"test124@gmail.com",
...
def test_posts(test_user, session,test_user2):
    posts_data=[{
        ...
        "title":"second title","content":"2nd content","owner_id":test_user['id']
        },{
        "title":"Third title","content":"3rd content","owner_id":test_user['id']
        },{
        "title":"Third title","content":"3rd content","owner_id":test_user2['id']
    }]
